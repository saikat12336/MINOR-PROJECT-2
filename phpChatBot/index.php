...
<html lang="en">
   ...
   <body id="ok" style="background-color: lightblue;">
      <div class="container" style="position: relative; top: 6rem;">
         <div class="row justify-content-md-center mb-4">
            <div class="col-md-6">
               <!--start code-->
               <div class="card" style="background-color:#ffd31a;">
					 ...
					 <ul class="list-unstyled messages-list">
							...
							if(mysqli_num_rows($res)>0){
								...
								while($row=mysqli_fetch_assoc($res)){
									...
									$html.='<li class="'.$class.' clearfix"><span class="message-img"><img src="image/'.$imgAvatar.'" class="avatar-sm rounded-circle"></span>
									<div class="message-body clearfix"><div class="message-header"><strong class="messages-title">'.$name.'</strong>
									<small class="time-messages text-muted"><span class="fas fa-time"></span> <span class="minutes">'.$time.'</span></small> </div>
									<p class="messages-p" style="border-color:blue;">'.$message.'</p></div></li>';
								}
								//echo $html;
							}else{
								?>
								<li class="messages-me clearfix start_chat">
								   <h5>	<b>Ask me about your problem..</b></h5>
								</li>
								<?php
							}
							?>
                  ...
                  <div class="card-header">
                    <div class="input-group">
					   ...
					   <input type="button" class="btn btn-primary" value="Send" onclick="send_msg()" style="background-color:black;">
					   </span>
					</div> 
                  </div>
               </div>
			...
			if(txt){
				jQuery.ajax({
					...
					success:function(result){
						var html='<li class="messages-you clearfix"><span class="message-img"><img src="image/bot_avatar.png" class="avatar-sm rounded-circle"></span><div class="message-body clearfix"><div class="message-header"><strong class="messages-title">Quanta</strong> <small class="time-messages text-muted"><span class="fas fa-time"></span> <span class="minutes">'+getCurrentTime()+'</span></small> </div><p class="messages-p">'+result+'</p></div></li>';
						jQuery('.messages-list').append(html);
