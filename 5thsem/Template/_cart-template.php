...
<section id="cart" class="py-4 mb-5">
    <div class="container-fluid w-75">
        <h5 class="font-baloo font-size-20"><b>Shopping Cart</b></h5>
        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row border-top py-3 mt-3">
                    <div class="col-sm-2">
                        <img src="<?php echo $item['item_image'] ?? "./assets/products/1007.png" ?>" style="height: 120px;" alt="cart1" class="img-fluid">
                    </div>
                    <div class="col-sm-8">
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                       ...
                       <a href="checkout.php" class="btn btn-warning mt-3 text-light"><i class="far fa-credit-card"></i> &nbsp; Proceed to Buy</a>
                    </div>
                </div>
            </div>
            <!-- !subtotal section-->
