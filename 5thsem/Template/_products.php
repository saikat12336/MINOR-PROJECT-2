...
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img src="<?php echo $item['item_image'] ?? "./assets/products/1007.png" ?>" alt="product" class="img-fluid">
            ...
            <div class="col-sm-6 py-5">
                ...
                <table class="my-3">
                    ...
                    <!-- <tr class="font-rale font-size-14">
                        <td>You Save:</td>
                        <td><span class="font-size-16 text-danger">$80.00</span></td>
                    </tr> -->
                </table>
                <!---    !product price       -->
                ...
                <div id="order-details" class="font-rale d-flex flex-column text-dark">
                    ...
                    <small><i class="fas fa-map-marker-alt color-primary"></i>&nbsp;&nbsp;Deliver to Customer - 781028</small>
                </div>
                <!-- !order-details -->
                    ...
                    <div class="col-6">
                        ...
                        <div class="color my-4">
                            <div class="d-flex justify-content-between">
                                <h6 class="font-baloo"><b>Color:</b></h6>
                ...
                <!-- size -->
                <div class="size my-3">
                    <h6 class="font-baloo"><b>Size:</b> </h6>
                    <div class="d-flex justify-content-between w-75">
                        <div class="font-rubik border p-3 bg-light">
                        <input type="radio" name="select">&nbsp 4GB RAM
                        </div>
                        <div class="font-rubik border p-3 bg-light">
                        <input type="radio" name="select">&nbsp 6GB RAM
                        </div>
                        <div class="font-rubik border p-3 bg-light">
                        <input type="radio" name="select">&nbsp 8GB RAM
                        </div>
                    </div>
                </div>
                <!-- !size -->
